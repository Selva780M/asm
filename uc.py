		...
		if len(df['STOCK']) > 0:
			while True:
				...
				for i in range(0,len(df100.index)):					
					if(df100.iloc[i,7]) > (df100.iloc[i,6]) and (df100.iloc[i,1] not in df5['NAME'].tolist()) and (df100.iloc[i,2] not in df5['STOCK'].tolist()):						
					...
					if(df100.iloc[i,7]) < (df100.iloc[i,5]) and (df100.iloc[i,1] not in df5['NAME'].tolist()) and (df100.iloc[i,2] not in df5['STOCK'].tolist()):						
