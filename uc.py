		...
		if len(df['STOCK']) > 0:
			while True:
				...
				for i in range(0,len(df100.index)):					
					if(df100.iloc[i,6]) < (df100.iloc[i,7]) and (df100.iloc[i,1] not in df5['NAME']) and (df100.iloc[i,2] not in df5['STOCK']):
						st.write('loop1')
					...
					if(df100.iloc[i,5]) > (df100.iloc[i,7]) and (df100.iloc[i,1] not in df5['NAME']) and (df100.iloc[i,2] not in df5['STOCK']):
						st.write('loop2')
